...
if compute_weights:
    class_weights = class_weight.compute_class_weight(class_weight='balanced', classes=train_set.label.unique(),
...
training_args = TrainingArguments(
    output_dir='../processed/modeling/results/paws_hyp_s3',
    report_to=None,
    ...
    warmup_steps=500,
    push_to_hub=False,
    logging_dir='../processed/modeling/logs/paws_hyp_s3',
    logging_steps=15,
    seed=42,
...
trainer.save_model("../processed/modeling/models/roberta_paws_weights_s3")