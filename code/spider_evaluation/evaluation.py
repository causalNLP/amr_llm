...
def evaluate(gold, predict, db_dir, etype, kmaps, plug_value, keep_distinct, progress_bar_for_each_datapoint,amr):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--amr', default=False, action='store_true',
                        help='whether we are evaluating AMR prediction')
    ...
    evaluate(args.gold, args.pred, args.db, args.etype, kmaps, args.plug_value, args.keep_distinct, args.progress_bar_for_each_datapoint,args.amr)
